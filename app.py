...
# Kalitlar
TELEGRAM_BOT_TOKEN = os.getenv("8290288100AAHfb8lnFyMBXlv8mDrBoH-XPvNa-mH9LLE")  # Sizning bot tokeni
BOTFATHER_TOKEN = os.getenv("8290288100AAHfb8lnFyMBXlv8mDrBoH-XPvNa-mH9LLE") or TELEGRAM_BOT_TOKEN
